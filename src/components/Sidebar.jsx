...
const Sidebar = ({ user, closeTooggle }) => {
  const handleCloseSidbar = () => {
    if(closeTooggle) closeTooggle(false);
  }

  return (
    <div className='flex flex-col justify-between bg-white h-full overflow-y-skrikk min-w-210 hide-scrollbar'>
